package com.example.elastic.staticClass;
...
public class DateUtils {
    ...
    public static final String MM_dd_FORMAT = "MM_dd";
    ...
    public static String getMD(Date date) {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat(MM_dd_FORMAT);
	...
	public static String addMon(Date date,int m) {  
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");  
        Calendar cl = Calendar.getInstance();  
        cl.setTime(date);  
        cl.add(Calendar.MONTH, m);
        date = cl.getTime();  
